...
const attributeSchema = new mongoose.Schema({
    ...
    ethnicity: { type: String, enum: ['africanAmerican', 'asian', 'caucasian', 'hispanic', 'pacificIslander', 'other'], required: true },
    language: { type: String, enum: ['english', 'spanish', 'french', 'german', 'mandarin', 'korean', 'other'], required: true },
